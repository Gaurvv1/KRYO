...
export default function App() {
  ...
  const handleDownload = () => {
    alert("In a production app, this would burn the text onto the image for download!");
  };

  return (
    <div className="min-h-screen bg-[#0f172a] text-gray-200 p-4 md:p-8">
      {/* Header */}
      ...
      <main className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8">
           <div className="sticky top-8">
              ...
              {memeData && !loading && (
                <div className="mt-6 bg-gray-800/80 backdrop-blur border border-gray-700 p-6 rounded-2xl animate-fade-in">
                  <div className="flex flex-col md:flex-row gap-6 justify-between items-start">
                    ...
                    <button 
                      ...
                      className="px-6 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg text-sm font-medium transition-colors whitespace-nowrap"
                    >
                      Download (Demo)
                    </button>
                  </div>
